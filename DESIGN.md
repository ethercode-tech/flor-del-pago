...
- Se aplica paleta oscura dominante:
  ...
  - Superficies `#181818` y `#202020`
  - Texto `#FFFFFF` / secundario `#B4B4B4`
  - Acento y CTA principal `#FFC000`
- Tipografia:
  - Titulares: serif display en mayusculas, gran escala y line-height comprimido
  - UI y cuerpo: sans moderna con tracking levemente expandido en botones/labels
- Botones:
  - Primario dorado sin border-radius
  - Secundario ghost blanco al 50 por ciento
  - Interacciones por color (sin animaciones exageradas)
- Hero:
  - Imagen full viewport con overlay cinematografico oscuro
  - Badges de escasez y geolocalizacion
  - Triple CTA (Reservar, Ver Menu, Conocer al Chef)
- Secciones con imagen:
  - Historia visual
  - Menu destacado con tarjetas y fotografia
  - Despensa con bloque full-bleed e imagen de producto
- Se mantiene SEO estructural y JSON-LD de restaurante.
